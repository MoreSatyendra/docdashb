...
const Medications = ({openMedications ,  setopenMedications ,  closeMeds ,  openMeds }) => {
    return (
        <>
          <Transition appear show={openMedications} as={Fragment}>
            <Dialog as="div" className="relative z-10 " onClose={closeMeds}>
              <Transition.Child
                as={Fragment}
                ...
                <div className="flex h-full items-center ml-[15%] p-4 text-center">
                  ...
                  >
                    <div className="w-[60%] h-full transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-2xl transition-all">
                      ...
                      >
                         <span className="text-2xl ml-2 text-purple-800 font-bold">Medications ..</span>
                         <CloseOutlinedIcon onClick={closeMeds} className="cursor-pointer hover:text-blue-600"/>
                      </Dialog.Title>
                      <div className="w-full h-[96%] mt-2 bg-slate-200  rounded-2xl overflow-hidden flex flex-col justify-between">
                        <iframe src={report}  style={{width:"100%" , height:"100%"}}  frameBorder="0"></iframe>
                      </div>
                    </div>
                  </Transition.Child>
                </div>
